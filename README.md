...
➜  Local:   https://localhost:5173/chainaware-tma
➜  Network: https://172.18.16.1:5173/chainaware-tma
...
link (`https://localhost:5173/chainaware-tma` in this example) in your
browser:
